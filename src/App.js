...
<body class="${isDarkTheme ? 'dark bg-gray-900 text-white' : 'bg-white text-gray-900'}">
    ...
    <!-- JavaScript for Dark Mode Toggle and PWA -->
    <script>
        // Dark Mode Toggle
...
const PortfolioGenerator = () => {
  ...
  // Project Modal (existing, but with dark mode support)
  ...
  // Main component continues with dark mode support...
    ...
    <div className={baseClasses}>
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-2 shadow-lg flex gap-2">
            {[
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      type="url"
                      value={portfolioData.personalInfo.videoBackground}
                      onChange={(e) => setPortfolioData(prev => ({
                        ...prev,
                        personalInfo: { ...prev.personalInfo, videoBackground: e.target.value }
                      }))}
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                      placeholder="https://ejemplo.com/video.mp4"
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Opcional: Video de fondo para la sección hero
                    </p>
                  </div>
          ...
          {/* Design Step - Enhanced with Dark Mode */}
          {currentStep === 'design' && (
            <div className="space-y-8">
              <div className="text-center mb-8">
              ...
              <div className="max-w-4xl mx-auto">
                {portfolioData.experience.map((exp, index) => (
                  <div key={index} className="relative pl-8 pb-12 last:pb-0">
                    ...
                    <div className={`absolute left-2 top-4 w-0.5 h-full ${
                      isDarkTheme ? 'bg-gray-700' : 'bg-gray-200'
                    } last:hidden`}></div>
                    
                    <div className={`${
                      isDarkTheme ? 'bg-gray-800' : 'bg-white'
                    } rounded-lg p-6 shadow-lg ml-6`}>
